...
<div class="container">
    ...
    <form class="text-center border border-light p-5" method="post">
        ...
        <!-- Name -->
        <input type="text" id="defaultContactFormName" class="form-control mb-4" value="<?php echo $post->getTitle();?>" name="title" ><br>

        <!-- Email -->
        <textarea rows="4" cols="50" name="content"><?php echo $post->getContent();?></textarea>
